...
//      admin password.
//
// PostgREST identifier casing: quoted columns (e.g. "ID", "Nama",
// "Tarikh") are exposed with their quoted case; unquoted columns fold
// to lowercase. Each table therefore has an explicit key remap from
// the SQLite key to the PostgREST-exposed key.
//
// Usage:
...
// ---------- Column remaps (SQLite key -> PostgREST key) ----------
...
const REMAP: Record<string, Record<string, string>> = {
  ...
  tblsenaraiprabungkus: {
    ...
    idUbat: "idubat",
    namaUbat: "namaubat",
    idPrabungkus: "idprabungkus",
    namaDagangan: "namadagangan",
    nomborKelompok: "nomborkelompok",
    tarikhLuputAsal: "tarikhluputasal",
    tarikhLuputBaharu: "tarikhluputbaharu",
    nomborMAL: "nombormal",
    kuantitiUntukDiprabungkus: "kuantitiuntukdiprabungkus",
    saizPek: "saizpek",
    deskripsiPek: "deskripsipek",
    hargaSetiapPek: "hargasetiappek",
    jumlahPekDihasilkan: "jumlahpekdihasilkan",
    arahanTambahan: "arahantambahan",
  },
  "uds.tblnamaubat": {
    ID: "ID",
  ...
  "uds.tblrekodlabel": {
    ...
    Kuantiti: "Kuantiti",
    Penyedia: "Penyedia",
    LuputNormalized: "LuputNormalized",
    NamaUbatID: "NamaUbatID",
  },
};
